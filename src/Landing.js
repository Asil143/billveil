          ...
          <div style={{ display: "grid", gridTemplateColumns: "240px 1fr", gap: 48, marginBottom: 48, alignItems: "start" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <button className="footer-link" onClick={() => router.push("/learn")} style={{ background: "none", border: "none", color: "#475569", fontSize: 12, fontWeight: 500, cursor: "pointer", fontFamily: FONT, textAlign: "left", padding: 0, transition: "color 0.15s" }}>Learn</button>
