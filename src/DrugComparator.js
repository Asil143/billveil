      ...
      <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: 24, marginBottom: 16 }}>
        ...
        <div style={{ marginTop: 10, marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {EXAMPLES.map((ex) => (
              <button key={ex} onClick={() => setDrug(ex)} style={{ padding: "5px 12px", background: drug === ex ? "rgba(16,185,129,0.15)" : "rgba(255,255,255,0.04)", color: drug === ex ? "#10b981" : "#64748b", border: `1px solid ${drug === ex ? "rgba(16,185,129,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: 24, fontSize: 12, fontWeight: 500, cursor: "pointer", transition: "all 0.15s", fontFamily: FONT }}>
                {ex}
              </button>
            ))}
          </div>
